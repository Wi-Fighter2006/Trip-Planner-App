...
app = Flask(__name__, template_folder='.') # Keep this to load index.html from the root
...
def generate():
    ...
    # --- PROMPT CHAINING (NOW WITH MORE FEATURES!) ---
    ...
    return jsonify({
        ...
        'maps_link': maps_link,
        'packing_list': packing_list, # New data
        'fun_fact': fun_fact          # New data
    })
